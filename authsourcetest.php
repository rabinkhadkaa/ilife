...
'auth0' => [
    'saml:SP', // Use the SAML module
    'entityID' => 'https://ilifes.store/simplesaml/module.php/saml/sp/metadata.php',
    'idp' => 'https://dev-6xu0s3t43xer76kc.us.auth0.com/samlp/OzeEfjrJAiiU2EIEOYtjaAc1HQx0bi2f', // Auth0 SSO URL
    'privatekey' => 'saml.pem', // Path to your private key
    'certificate' => 'saml.crt', // Path to your public certificate
    'redirect.sign' => true,
    'sign.logout' => true,
    'sign.authnrequest' => true,
    'acs' => 'https://ilifes.store/simplesaml/module.php/saml/sp/saml2-acs.php/default-sp',  // Add this line
],
