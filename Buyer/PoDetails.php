            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <form method="post" action="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="comments" name="comments" class="form-control" rows="4" readonly><?php echo htmlspecialchars($result['Comments']); ?></textarea>
                                </div>
                ...
                <div class="col-md-6">                    
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <iframe src="/var/www/html/files/PO_files/<?php echo 'PO_Request_'.$result['RequestID']; ?>.pdf" width="100%" height="500px"></iframe>
                        </div>
                    </div>
                </div>
            </div>
