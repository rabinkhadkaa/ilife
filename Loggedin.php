...
<html lang="en">
  ...
  <body>
    ...
    <div class = "container my-3">
        <h2>Add a note</h2>
        <form action = "Loggedin.php ? update=true" method = "post" >
            <div class="mb-3">
              <label for="title" class="form-label">Note title</label>
              <input type="text" name = "title" class="form-control" id="tile" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
              <label for="Desc" class="form-label">Note Description</label>
        ...
        Array.from(deletes).forEach((element)=>{
          element.addEventListener("click", (e)=>{
            ...
            if(confirm("Are you sure you want to delete this note!")){
              console.log("yes--");
              console.log(SN);
              window.location = `/PHP/CRUD/Loggedin.php?delete=${SN}`;
            } else {
              console.log("No");
            }
          }) 
